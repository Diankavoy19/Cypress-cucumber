...
import DeveloperButtons from "../../pageobjects/DeveloperButtons";
import Development from "../../pageobjects/Development";
import Explore from "../../pageobjects/ExploreMessaginglink";
import Integration from "../../pageobjects/Integration";
import LTENetworks from "../../pageobjects/LTENetworks";
import Postman from "../../pageobjects/Postman";
import ReleaseNotes from "../../pageobjects/ReleaseNotes";
import ReportAbuseForm from "../../pageobjects/ReportAbuseForm";
import VideoPage from "../../pageobjects/VideoPage";
import Webrtc from "../../pageobjects/Webrtc";
import HelpfulInput from "../../pageobjects/WhatWasMostHelpfulInput";
import NetButton from "../../pageobjects/NetButton";
import TollFreeNumbers from "../../pageobjects/TollFreeNumbers";

const base = new Base();
const explore = new Explore();
const postman = new Postman();
const calculator = new Calculator();
const integrations = new Integration();
const helpfulInput = new HelpfulInput();
const development = new Development();
const reportabuseform = new ReportAbuseForm();
const compliance = new Compliance();
const releasenotes = new ReleaseNotes();
const ltenetworks = new LTENetworks();
const videopage = new VideoPage();
const webrtc = new Webrtc();
const developerbuttons = new DeveloperButtons();
const net = new NetButton();
const tollfreenumbers = new TollFreeNumbers();
